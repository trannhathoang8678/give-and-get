...
public class GatewayConstant {
    ...
    public static void addApiEntities(){
        apiEntities.add(new ApiEntity("getAllUser","/manager/**","GET","ADMIN"));
        apiEntities.add(new ApiEntity("deleteUser","/manager/**","POST","ADMIN"));
        apiEntities.add(new ApiEntity("getAllReport","/manager/**","PUT","ADMIN"));
        apiEntities.add(new ApiEntity("replyReport","/manager/**","DELETE","ADMIN"));
