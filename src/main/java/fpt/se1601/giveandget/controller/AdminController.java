...
public class AdminController {
    ...
    public String updateArea(@RequestBody String name)
    {
        if(donationService.updateArea(name)!=null)
    ...
    public String updateDonationType(@RequestBody String name)
    {
        if(donationService.updateDonationType(name)!=null)
